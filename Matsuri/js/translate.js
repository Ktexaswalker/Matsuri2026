const translations = {
    ...
    日本語: {
        ...
        "Matsuri Barcelona is an annual event where you can enjoy Japanese culture, featuring top artists and performances, numerous exhibitors, Japanese food and drinks, a children’s area, and various activities typical of Japanese festivals, so you can enjoy an immersive and fun weekend with your family and friends.":"マツリ・バルセロナは、日本文化を楽しめる年に一度のイベントです。最高のアーティストやパフォーマンス、多数の出展者、日本の飲食、子ども向けエリア、そして日本の祭りならではのさまざまな体験型アクティビティが揃い、家族や友人と一緒に没入感あふれる楽しい週末を過ごすことができます。",
        "Information":"情報",
        "PROGRAM":"プログラム",
        "PERFORMERS":"出演者",
        "KIDS":"キッズ",
        "BOOTHS":"ブース",
        "FOOD AND DRINKS":"食べ物と飲み物",
        "Location":"位置",
        "Moll de la Fusta":"Moll de la Fusta",
        "Ronda Litoral, 1740, Ciutat Vella, 08039 Barcelona":"ロンダ リトラル、1740、シウタット ベーリャ、08039 バルセロナ",
        "Subway: Drassanes (L3)":"地下鉄: ドラサネス (L3)",
        "Bus: V13, 59, D20":"バス: V13、59、D20",
        "Nearby parking available":"近くに駐車場あり",
        "Be part of Matsuri":"祭りに参加しよう",
        "Join our community as volunteer or help us make one of Barcelona's greatest Japanese festival through crowdfunding.":"私たちのコミュニティにボランティアとして参加するか、クラウドファンディングを通じてバルセロナ最大の日本フェスティバルの実現に協力してください。",
